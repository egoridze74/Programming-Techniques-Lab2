...
male_first = ['Иван', 'Петр', 'Алексей', 'Дмитрий', 'Сергей', 'Виктор', 'Андрей', 'Богдан', 'Антон', 'Марк', 'Егор', 'Павел', 'Степан', 'Семен', 'Прохор', 'Рики', 'Владислав', 'Олег', 'Никита']
male_last = ['Иванов', 'Петров', 'Сидоров', 'Кузнецов', 'Смирнов', 'Будейко', 'Викторов', 'Богданов', 'Антонов', 'Марков', 'Егоров', 'Павлов', 'Степанов', 'Семенов', 'Прохоров', 'Рик', 'Владиславов', 'Олегов', 'Никитов']
male_middle = ['Иванович', 'Петрович', 'Алексеевич', 'Дмитриевич', 'Сергеевич', 'Викторович', 'Андреевич', 'Богданович', 'Антонович', 'Маркович', 'Егорович', 'Павлович', 'Степанович', 'Семенович', 'Прохорович', 'Рикович', 'Владиславович', 'Олегович', 'Никитич']
...
def gen_fio(is_male):
    ...
    fio = f'{random.choice(lasts)} {random.choice(firsts)} {random.choice(middle)}'
...
for size in sizes:
    ...
    with open(f'data/zags_{size}.csv', 'w', newline='', encoding='cp1251') as f:
        writer = csv.writer(f)
